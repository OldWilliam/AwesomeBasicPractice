...
public class DigestUtils {
    ...
    public static MessageDigest getMd5Digest() {
        return getDigest(me.jim.wx.gradle.digest.MessageDigestAlgorithms.MD5);
    }
     ...
     *             built-in algorithm
     * @see me.jim.wx.gradle.digest.MessageDigestAlgorithms#SHA_1
     * @since 1.7
     */
    public static MessageDigest getSha1Digest() {
        return getDigest(me.jim.wx.gradle.digest.MessageDigestAlgorithms.SHA_1);
    }
     ...
     *             built-in algorithm
     * @see me.jim.wx.gradle.digest.MessageDigestAlgorithms#SHA_256
     */
    public static MessageDigest getSha256Digest() {
        return getDigest(me.jim.wx.gradle.digest.MessageDigestAlgorithms.SHA_256);
    }
     ...
     *             built-in algorithm
     * @see me.jim.wx.gradle.digest.MessageDigestAlgorithms#SHA_384
     */
    public static MessageDigest getSha384Digest() {
        return getDigest(me.jim.wx.gradle.digest.MessageDigestAlgorithms.SHA_384);
    }
     ...
     *             built-in algorithm
     * @see me.jim.wx.gradle.digest.MessageDigestAlgorithms#SHA_512
     */
     ...
     *
     * @param data
     *            Data to digest; converted to bytes using {@link me.jim.wx.gradle.digest.StringUtils#getBytesUtf8(String)}
     * @return MD5 digest
     */
    public static byte[] md5(final String data) {
        return md5(me.jim.wx.gradle.digest.StringUtils.getBytesUtf8(data));
    }
    ...
    public static byte[] sha1(final String data) {
        return sha1(me.jim.wx.gradle.digest.StringUtils.getBytesUtf8(data));
    }
    ...
    public static byte[] sha256(final String data) {
        return sha256(me.jim.wx.gradle.digest.StringUtils.getBytesUtf8(data));
    }
    ...
    public static byte[] sha384(final String data) {
        return sha384(me.jim.wx.gradle.digest.StringUtils.getBytesUtf8(data));
    }
    ...
    public static byte[] sha512(final String data) {
        return sha512(me.jim.wx.gradle.digest.StringUtils.getBytesUtf8(data));
    }
     ...
     * @param valueToDigest
     *            the value to update the {@link MessageDigest} with;
     *            converted to bytes using {@link me.jim.wx.gradle.digest.StringUtils#getBytesUtf8(String)}
     * @return the updated {@link MessageDigest}
     * @since 1.7
     */
    public static MessageDigest updateDigest(final MessageDigest messageDigest, final String valueToDigest) {
        messageDigest.update(me.jim.wx.gradle.digest.StringUtils.getBytesUtf8(valueToDigest));
        return messageDigest;
    }
}