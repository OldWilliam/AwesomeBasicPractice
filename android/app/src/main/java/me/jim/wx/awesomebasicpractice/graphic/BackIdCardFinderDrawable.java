 ...
 * Description: 身份证正面取景
 */
public class BackIdCardFinderDrawable extends Drawable {
    private final Bitmap mEmblem;
    private final Bitmap mEdge;
    private Paint mPaint;

    public BackIdCardFinderDrawable(Context context) {
        this.mPaint = new Paint();
        mPaint.setAntiAlias(true);
        mEmblem = ((BitmapDrawable) context.getResources().getDrawable(R.drawable.cover_card_back_emblem)).getBitmap();
