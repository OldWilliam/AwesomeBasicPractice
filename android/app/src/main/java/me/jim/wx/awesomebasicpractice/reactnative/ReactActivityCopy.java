...
public abstract class ReactActivityCopy extends AppCompatActivity
     ...
     */
    protected ReactActivityDelegateCopy createReactActivityDelegate() {
        return new ReactActivityDelegateCopy(this, getMainComponentName());
    }
